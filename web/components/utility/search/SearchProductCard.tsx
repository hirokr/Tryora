...
export function SearchProductCard({
  ...
  const resolvedLikeCount = likeCount ?? Math.max(0, Math.round(product.trendingScore || 0));
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] bg-black/30">
        ...
        <div className="pointer-events-none absolute inset-x-0 top-0 flex justify-end gap-2 bg-gradient-to-b from-black/65 to-transparent p-3 opacity-0 transition-opacity group-hover:opacity-100">
          <button
            type="button"

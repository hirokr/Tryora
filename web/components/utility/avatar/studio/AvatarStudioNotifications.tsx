        ...
        <div className="absolute bottom-24 right-8 z-50 w-80 rounded-xl border border-primary/30 bg-[#1f1328]/90 p-5 shadow-2xl backdrop-blur-xl">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined animate-pulse text-primary">magic_button</span>
              <h3 className="text-sm font-bold tracking-wide text-slate-100">VTON Rendering in Progress...</h3>
            </div>
          ...
          <div className="space-y-3">
            <div className="mb-1 flex items-end justify-between">
              <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Generating Mesh Updates</span>
          ...
          <div className="mt-6 flex items-center justify-between border-t border-white/5 pt-4">
            ...
            <span className="text-[9px] font-medium uppercase text-slate-500">Est. 4s remaining</span>
          </div>
        </div>
      )}
        ...
        <div className="absolute bottom-24 right-8 z-50 w-80 rounded-xl border border-red-500/50 bg-[#1f1328]/90 p-5 shadow-[0_0_20px_rgba(239,68,68,0.2)] backdrop-blur-xl">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold tracking-wide text-slate-100">VTON Rendering Failed</h3>
            </div>
            <button onClick={onClear}>
              <span className="material-symbols-outlined cursor-pointer text-xs text-slate-500 hover:text-white">close</span>
            </button>

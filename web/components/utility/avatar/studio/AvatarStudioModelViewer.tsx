...
function LoadingState() {
	return (
		<div className='flex h-full min-h-104 w-full items-center justify-center rounded-4xl border border-white/10 bg-[radial-gradient(circle_at_top,rgba(140,43,238,0.2),transparent_55%),linear-gradient(180deg,rgba(10,10,20,0.92),rgba(8,8,16,0.96))] p-8 text-center text-sm text-slate-300'>
...
export function AvatarStudioModelViewer({
	...
	return (
		<div className='overflow-hidden rounded-4xl border border-white/10 bg-[linear-gradient(180deg,rgba(16,12,24,0.98),rgba(8,8,16,0.98))] shadow-[0_24px_90px_rgba(0,0,0,0.35)]'>
			...
			<div className='relative min-h-104 w-full'>
				<Suspense fallback={<LoadingState />}>
					<Canvas
						camera={{ position: [0, 0.8, 3.4], fov: 42 }}
						className='h-104 w-full md:h-136'

  ...
  return (
    <section className="mt-10">
      <div className="mb-4">
        ...
        <h2 className="text-xl font-bold text-white">People are using these try-on looks</h2>
      ...
      {isLoading ? <p className="text-sm text-slate-300">Loading trending try-ons...</p> : null}

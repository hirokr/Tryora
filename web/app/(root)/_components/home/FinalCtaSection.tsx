...
type FinalCtaSectionProps = {
  createAvatarHref: string;
};

export function FinalCtaSection({ createAvatarHref }: FinalCtaSectionProps) {
  return (
    <section className="relative bg-background-dark py-24 lg:py-40">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link href={createAvatarHref} className="flex h-16 items-center rounded-2xl bg-primary px-10 text-xl font-bold text-white shadow-[0_0_40px_rgba(140,43,238,0.3)] transition-transform hover:scale-105">
            Create Your Avatar
          </Link>
        </div>

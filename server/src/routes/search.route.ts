 ...
 *     description: |
 *       Returns a single product record by its ID for authenticated access. Use this endpoint
 *       when a client already knows the product ID and needs full record details.
 *     tags:
 *       - Search
 *     security:
 *       - bearerAuth: []

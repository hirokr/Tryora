# tests/unit/dress_search

## Purpose
Automated tests grouped by scope (unit/integration) and domain.
...
- Protect behavior with fast unit checks and realistic integration flows.

...
class Settings(BaseSettings):
    ...
    # Rate limits
    MAX_TRIPO_CALLS_PER_USER: int = Field(default=10, validation_alias="MAX_TRIPO_CALLS_PER_USER")
    MAX_TRIPO_CALLS_GLOBAL: int = Field(default=500, validation_alias="MAX_TRIPO_CALLS_GLOBAL")
    TRIPO_RATE_WINDOW_SECONDS: int = Field(default=3600, validation_alias="TRIPO_RATE_WINDOW_SECONDS")
